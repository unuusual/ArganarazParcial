...
public class SegundoParcial {
	...
	@Test
	public void queSePuedanAdministrarDistintosTiposDePolizas() { // A PARTIR DE ACA REVISTAR LO DE ABAJO, TENGO MUCHAS
																	// DUDAS!
		...
		libra.agregarPoliza(
				new PolizaAccidentesPersonales(3, new Persona("Pedro", 455647345, 24), 2000000.0, 5000.0, 3000.0));
		libra.agregarPoliza(
				new PolizaCombinadoFamiliar(4, new Persona("Natalia", 45987345, 24), 2000000.0, 5000.0, 4000.0));
	...
	@Test
	public void queSePuedaDenunciarElRoboDeUnAuto() throws PolizaNoExiste{
		Integer numeroDePoliza = 1;
		CompaniaDeSeguro libra = new CompaniaDeSeguro("Libra");

		libra.agregarPoliza(
				new PolizaDeAuto(numeroDePoliza, new Persona("Camila", 45987345, 24), 2000000.0, 5000.0, 4000.0));
	...
	@Test
	public void queSePuedaDenunciarUnSiniestroParaUnaPolizaDeVida() throws PolizaNoExiste{
		int numeroDePoliza = 1;
		CompaniaDeSeguro libra = new CompaniaDeSeguro("Libra");

		libra.agregarPoliza(
				new PolizaAccidentesPersonales(1, new Persona("Pedro", 455647345, 24), 2000000.0, 5000.0, 400.0));
	...
	@Test(expected = PolizaNoExiste.class)
	public void verificarQueNoSePuedaDenunciarUnSiniestroParaUnaPolizaQueNoExista() throws PolizaNoExiste{
		int numeroDePoliza = 1;
		CompaniaDeSeguro libra = new CompaniaDeSeguro("Libra");
		...
		libra.agregarPoliza(
				new PolizaDeAuto(numeroDePoliza++, new Persona("Camila", 45987345, 24), 2000000.0, 5000.0, 4000.0));
		libra.agregarPoliza(
				new PolizaDeAuto(numeroDePoliza++, new Persona("Juan", 2745123, 24), 1500000.0, 4000.0, 4000.0));
		libra.agregarPoliza(new PolizaAccidentesPersonales(numeroDePoliza++, new Persona("Pedro", 455647345, 24),
				2000000.0, 5000.0, 4000.0));
		libra.agregarPoliza(new PolizaCombinadoFamiliar(numeroDePoliza++, new Persona("Natalia", 45987345, 24),
				2000000.0, 5000.0, 4000.0));
